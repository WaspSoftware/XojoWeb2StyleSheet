#tag Class
Protected Class WASPWebTextArea
Inherits WebTextArea
	#tag Event
		Sub Opening()
		  ' ----------------------------------------------------------------------
		  ' Procedure Name: WASPWebTextArea.Opening
		  ' By            : Jim Brock
		  ' Notes
		  ' Set the CSS class
		  ' ----------------------------------------------------------------------
